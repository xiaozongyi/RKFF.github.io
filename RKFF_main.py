...
dataset              = 'cityscapes'    # coco, cityscapes
use_sbd              = False       # Use Semantic Boundaries Dataset
workers              = 0           # Dataloader threads
...
epochs               = 50           # 30 for coco, 200 for cityscapes
start_epoch          = 0
batch_size           = 10
test_batch_size      = 1
...
lr                   = 1e-2        # 0.1 for coco, 0.01 for cityscapes
...
# Checking Point
resume               = '/root/WASP/cityscapes_pre_trained.pth.tar'
checkname            = 'WASPNet'
...
# Checking Point
parser.add_argument('--resume', type=str, default='/root/WASP/cityscapes_pre_trained.pth.tar')
